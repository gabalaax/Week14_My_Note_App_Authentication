...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-row items-center justify-center mt-2 ">
      <div className="mx-auto rounded-lg bg-blue-500 p-10 shadow-2xl md:w-3/4 lg:w-1/2">
        ...
        >
          <Form>
            ...
            <button
              type="submit"
              className="mt-4 rounded-3xl bg-yellow-400 px-12 py-3 text-white hover:bg-yellow-500"
            >
              Register
            </button>
          </Form>
